...
beautiful.init("themes/rmoutard/theme.lua")
...
globalkeys = awful.util.table.join(
    -- Each 'tag' is equivalent to a 'workspace'
    -- Change Workspace.
    awful.key({ modkey,           }, "Left",   awful.tag.viewprev       ),
    awful.key({ modkey,           }, "Right",  awful.tag.viewnext       ),
    awful.key({ modkey,           }, "Escape", awful.tag.history.restore),

    -- Focus the next window into the same workspace.
    awful.key({ modkey,           }, "k",
        function ()
            awful.client.focus.byidx( 1)
            if client.focus then client.focus:raise() end
    ...
    -- Layout manipulation
    --     Change position of the window is the same workspace.
    awful.key({ modkey, "Shift"   }, "j", function () awful.client.swap.byidx(  1)    end),
    awful.key({ modkey, "Shift"   }, "k", function () awful.client.swap.byidx( -1)    end),
    --     Go to the equivalent window in the oposite workspace.
    ...
    awful.key({ modkey,           }, "F3", function () awful.util.spawn(application_launcher) end),
    awful.key({ modkey,           }, "a", function () awful.util.spawn(application_launcher) end),
    awful.key({ modkey,           }, "F4", function () awful.util.spawn(eclipse) end),
    awful.key({ modkey,           }, "F5", function () awful.util.spawn(pidgin) end),
    awful.key({ modkey,           }, "F6", function () awful.util.spawn(thunderbird) end),
    awful.key({ modkey,           }, "F7", function () awful.util.spawn(browser) end),
    awful.key({ modkey,           }, "F12", function () awful.util.spawn(lockscreen) end),
    awful.key({ modkey,           }, "F10", function () awful.util.spawn(nautilus) end),
    awful.key({ modkey,           }, "F9", function () awful.util.spawn(screenshot) end),
